...
<div class="sidebar" id="sidebar">
  ...
  <ul>
    ...
    <li><a href="#"><i class="fas fa-calendar-week"></i>Booking</a></li>
...
<div class="notif1">
  ...
  <div id="categories">
    ...
    <div class="items">
      <div class="item">
        <img src="photos/cat-indoor-chicken.jpg" alt="cat Food 1">
        <p>Cat Indoor Chicken Food - Php 275</p>
        <button onclick="addToCart('Food 1', 275)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat_food_salmon_brown_rice.jpg" alt="cat Food 2">
        <p>Cat Food Salmon Brown Rice - Php 465</p>
        <button onclick="addToCart('Food 2', 465)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/ocean fish dry cat food.jpg" alt="dog Food 3">
        <p>Ocean Fish Dry Cat Food - Php 140</p>
        <button onclick="addToCart('Food 3', 140)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/seafood-dry-cat-food.jpg" alt="dog Food 4">
        <p>Seafood Dry Cat Food - Php 1,110</p>
        <button onclick="addToCart('Food 4', 1,110)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat-friskies-seafood.jpg" alt="dog Food 5">
        <p>Cat Friskies Seafood - Php 1,189</p>
        <button onclick="addToCart('Food 5', 1,189)">Add to Cart</button>
      </div>
    </div>
    <br>
    <br>
    <div class="items">
      <div class="item">
        <img src="photos/dog_food_beef_sweet_potato.jpg" alt="Dog Food 6">
        <p>Dog Beef sweet Potato Food - Php 510</p>
        <button onclick="addToCart('Food 6', 510)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/small-dog-food.jpg" alt="Dog Food 7">
        <p>Pedigree Small Dog Roasted Chicken - Php 536</p>
        <button onclick="addToCart('Food 7', 536)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/kibles 'n Bits.png" alt="Dog Food 8">
        <p>Kibbles 'n Bits Orginal - Php 608</p>
        <button onclick="addToCart('Food 8', 608)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/food.jpg" alt="Dog Food 9">
        <p>Pedigree Nutrition Adult Dry Dog Food - Php 2,602</p>
        <button onclick="addToCart('Food 9', 2,602)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/dog_food_chicken_rice.jpg" alt="Dog Food 10">
        <p>Dog Food Chicken Rice- Php 558</p>
        <button onclick="addToCart('Food 10', 558)">Add to Cart</button>
      </div>
    </div>
    <h2>Your Cart</h2>
  <div id="cart">
