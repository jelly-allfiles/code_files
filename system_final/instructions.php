...
.contact-info .social-media a {
  font-size: 1.2em;
  color:rgb(40, 106, 167);
  text-decoration: none;
}

.contact-info .social-media a:hover {
    color:rgb(40, 159, 167);
  text-decoration: underline;
}
...
<div class="notif1">
    <i class="fa-solid fa-bell"></i>
        ...
        <h1>Instructions for Emergency</h1>
  ...
  <p>If you have any questions or need assistance, feel free to reach out to us through the following:</p>
  <ul>
    <li><strong>Phone:</strong> +6317 703 0022</li>
    <li><strong>Email:</strong> <a href="mailto:drbingols@gmail.com">furEvermanagement@gmail.com</a></li>
    <li><strong>Address:</strong> Kilat St., Pahina Central, Cebu City</li>
  </ul>
  <h3>Follow Us:</h3>
  <ul class="social-media">
    <li><a href="https://www.facebook.com/petclinic" target="_blank">Facebook</a></li>
    <li><a href="https://www.instagram.com/petclinic" target="_blank">Instagram</a></li>
    <li><a href="https://twitter.com/petclinic" target="_blank">Twitter</a></li>
  </ul>
</div>
