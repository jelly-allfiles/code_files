...
<h2><a href="order-pets.php">Pet Food</a> <a href="order-pets-accesories.php">Accessories</a> <a href="order-pet-medicine.php">Pets Medicine</a></h2>
    <div class="items">
      <div class="item">
        <img src="photos/dog medicine.jpg" alt="Medicine 1">
        <p>Propyrin Analgesic OTC Fever Wound Medicine  - Php 286</p>
        <button onclick="addToCart('Medicine 1', 286)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/both medicine.jpg" alt="Medicine 2">
        <p>Pulmo Care for bronchitis, pneumonia and kennel cough - Php 250</p>
        <button onclick="addToCart('Medicine 2', 250)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/medicine.jpg" alt="Medicine 3">
        <p>Anti-Diarrhea Liquid - Php 402</p>
        <button onclick="addToCart('Medicine 3', 402)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/medicine for vomiting.jpg" alt="Medicine 4">
        <p>Papi Emetix - Php 115</p>
        <button onclick="addToCart('Medicine 4', 115)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/anti itch.jpg" alt="Medicine 5">
        <p>Cassiel Pet Anti ltch Tablets Skin Disease Medicine - Php 110</p>
        <button onclick="addToCart('Medicine 5', 110)">Add to Cart</button>
      </div>
    </div>
    <br>
    <br>
    ...
    <div class="items">
      <div class="item">
        <img src="photos/dog medicine for appetite.jpg" alt="Medicine 6">
        <p>Astral Nutrition OPTIANML Allurexin Appetite - Php 100</p>
        <button onclick="addToCart('Medicine 6', 30)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat digestive.jpg" alt="Medicine 7">
        <p>HomeoPet Feline Digestive Upsets - Php 150</p>
        <button onclick="addToCart('Medicine 7', 150)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/dog wound medicine.jpg" alt="Medicine 8">
        <p>Vetericyn Plus Dog Wound Care Spray - Php 130</p>
        <button onclick="addToCart('Medicine 8', 130)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat wound medicine.jpg" alt="Medicine 9">
        <p>Vetericyn Plus Cat Wound Care Hydrogel Spray - $130</p>
        <button onclick="addToCart('Medicine 9', 30)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/flea&tick treatment.jpg" alt="Medicine 10">
        <p>FRONTLINE Spot On Flea & Tick Treatment - Php 110</p>
        <button onclick="addToCart('Medicine 10', 110)">Add to Cart</button>
      </div>
    </div>
    <h2>Your Cart</h2>
  <div id="cart">
