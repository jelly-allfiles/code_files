...
<h2><a href="order-pets.php">Pet Food</a> <a href="order-pets-accesories.php">Accessories</a> <a href="order-pet-medicine.php">Pets Medicine</a></h2>
    <div class="items">
      <div class="item">
        ...
        <p>Dog Bed - $15</p>
        <button onclick="addToCart('Accessory 1', 15)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/dog-clothes.jpg" alt="cat Accessory 2">
        <p>Dog Clothes - $30</p>
        <button onclick="addToCart('Accessory 2', 30)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/dog_leash.jpg" alt="dog Accessory 3">
        <p>Dog Leash - $50</p>
        <button onclick="addToCart('Accessory 3', 50)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/dogtoys.jpg" alt="Dog Accessory 4">
        <p>Dog Toys - $40</p>
        <button onclick="addToCart('Accessory 4', 40)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/dog_collar.jpg" alt="Dog Accessory 5">
        <p>Dog Collar - $60</p>
        <button onclick="addToCart('Accessory 5', 60)">Add to Cart</button>
      </div>
    </div>
    <br>
    <br>
    <div class="items">
      <div class="item">
        ...
        <p>Cat Bed - $70</p>
        <button onclick="addToCart('Accessory 6', 70)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat_scratching_post.jpg" alt="cat Accessory 7">
        <p>Cat Scratching Post - $80</p>
        <button onclick="addToCart('Accessory 7', 80)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat-clothes.jpg" alt="dog Accessory 8">
        <p>Cat Clothes - $50</p>
        <button onclick="addToCart('Accessory 8', 50)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat-collar.jpg" alt="Dog Accessory 9">
        <p>Cat Collar - $30</p>
        <button onclick="addToCart('Accessory 9', 30)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat-toys.jpg" alt="Dog Accessory 10">
        <p>Cat Toys - $40</p>
        <button onclick="addToCart('Accessory 10', 40)">Add to Cart</button>
      </div>
    </div>
    <h2>Your Cart</h2>
  <div id="cart">
