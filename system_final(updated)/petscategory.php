...
$sql = "SELECT photo, petName, breedName, healthIssue, description FROM health_records";
...
<head>
    ...
    <title>Pet Breed Category</title>
    <style>
    * {
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <line x1="4" x2="20" y1="18" y2="18"></line>
    ...
    <form id="petForm" method="POST" enctype="multipart/form-data" onsubmit="return saveRecord(event)">
        <h2>Upload Pet Photo</h2>
        <label for="petPhoto" style="color: black;">Select a photo of your pet:</label>
        <input type="file" id="petPhoto" name="petPhoto" accept="image/*" required>

        <h2>Pet Breed Category</h2>
        <label for="petName" style="color: black;">Pet Name:</label>
        <input type="text" id="petName" name="petName" required>

        <label for="breedName" style="color: black;">Breed Name:</label>
        <input type="text" id="breedName" name="breedName" required>

        <label for="species" style="color: black;">Species (Cat/Dog):</label>
        ...
        <label for="healthIssue" style="color: black;">Health Issue:</label>
