  ...
  <div id="categories">
    ...
    <div class="items">
      <div class="item">
        ...
        <p>Cat Indoor Chicken Food - $83.19</p>
        <button onclick="addToCart('Food 1', 83.19)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat_food_salmon_brown_rice.jpg" alt="cat Food 2">
        <p>Cat Food Salmon Brown Rice - $90.99</p>
        <button onclick="addToCart('Food 2', 90.99)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/ocean fish dry cat food.jpg" alt="dog Food 3">
        <p>Ocean Fish Dry Cat Food - $30.99</p>
        <button onclick="addToCart('Food 3', 30.99)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/seafood-dry-cat-food.jpg" alt="dog Food 4">
        <p>Seafood Dry Cat Food - $40.89</p>
        <button onclick="addToCart('Food 4', 40.89)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/cat-friskies-seafood.jpg" alt="dog Food 5">
        <p>Cat Friskies Seafood - $60.88</p>
        <button onclick="addToCart('Food 5', 60.88)">Add to Cart</button>
      </div>
    </div>
    <br>
    <br>
    <div class="items">
      <div class="item">
        ...
        <p>Dog Beef sweet Potato Food - $20.15</p>
        <button onclick="addToCart('Food 6', 20.15)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/small-dog-food.jpg" alt="Dog Food 7">
        <p>Pedigree Small Dog Roasted Chicken - $50.55</p>
        <button onclick="addToCart('Food 7', 50.55)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/kibles 'n Bits.png" alt="Dog Food 8">
        <p>Kibbles 'n Bits Orginal - $30.87</p>
        <button onclick="addToCart('Food 8', 30.87)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/food.jpg" alt="Dog Food 9">
        <p>Pedigree Nutrition Adult Dry Dog Food - $40.45</p>
        <button onclick="addToCart('Food 9', 40.45)">Add to Cart</button>
      </div>
      <div class="item">
        <img src="photos/dog_food_chicken_rice.jpg" alt="Dog Food 10">
        <p>Dog Food Chicken Rice- $60.56</p>
        <button onclick="addToCart('Food 10', 60.56)">Add to Cart</button>
      </div>
    </div>
    <h2>Your Cart</h2>
  <div id="cart">
