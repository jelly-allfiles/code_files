...
<body>
    <div class="container">
        ...
        <h1>What is Haikyuu?</h1>

        <h2>Shoyo Hinata develops a passion for volleyball after watching the "Tiny Giant," 
            a similarly diminutive high school student, play on TV series. Hinata is immediately 
            driven to learn and forms his own middle school volleyball team, even if he is the 
            only player for two years.</h2>
